        ...
        if (isset($afdelingSelection)){
          ...
          if ($afdelingSelection != 'all' && $afdelingSelection != ''){
            ...
            if ($workQuery->have_posts() ){
              ...
              echo '<div class="infoFirma infoText">' . get_field('firma') . '</div>';
              echo '<div class="infoAddress infoText">' . get_field('firmaAddress') . '</div>';
              echo '<div class="infoAddress infoText">' . get_field('firmaCity') . '</div>';
              echo '<div class="infoPhone infoText"> Tlf: +45 '. substr(get_field('firmaPhone'),0,2) . " " . substr(get_field('firmaPhone'),2,2) . " " .  substr(get_field('firmaPhone'),4,2) . " " . substr(get_field('firmaPhone'),6,2) . '</div>'; //The substrings split the phone number into groups of 2 digits
              echo '</div>';
            echo '</div>';
          ...
          echo '<div class="footerContainer">';
              ...
              echo '<div class="footerContainerRight">';
                echo '<div class="footerContact footerPhone">';
                  ...
                  echo '</svg>';
                  echo '+45 ' . substr(get_field('firmaPhone'),0,2) . " " . substr(get_field('firmaPhone'),2,2) . " " .  substr(get_field('firmaPhone'),4,2) . " " . substr(get_field('firmaPhone'),6,2);
                echo '</div>';
